...
public class NumberLetterCounts {
    ...
    public static String verifyUnitsArray(String value) {
        ...
        if (index2 == 0 && index3 == 0) {
            ...
            return ones[index1] + (!flag ? units[0] : units[1]) + "and" + NumberLetterCounts.verifyOnesArray(index3);
        } else if (index2 != 0 && index3 == 0) {
            return ones[index1] + (!flag ? units[0] : units[1]) + "and" + NumberLetterCounts.verifyTeensAndTensArray(index2 + "" + index3);
        } else if (index2 != 0 && index3 != 0) {
            return ones[index1] + (!flag ? units[0] : units[1]) + "and" + NumberLetterCounts.verifyTeensAndTensArray(index2 + "" + index3);
        }
